...
class IsValidUserAgentValidationRule extends PassboltValidationRule
{
    /**
     * @inheritDoc
     */
    ...
    {
        return __('The provided user agent is invalid.');
    }
    ...
    {
        return UserAgentValidation::isValid($value);
    }
}
