...
class AuthLoginControllerTest extends IntegrationTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->keyid = '03F60E958F4CB29723ACDF761353B5B15D9B054F';
    }
    ...
    public function testStage1UserToken()
    {
        ...
        $this->assertTrue(
            $this->_gpg->adddecryptkey($this->keyid, ''),
    ...
    protected function _gpgSetup()
    {
        ...
        $this->_gpg->import(Configure::read('passbolt.gpg.serverKey.public'));
        $this->_gpg->import(Configure::read('passbolt.gpg.serverKey.private'));
        $this->_gpg->import(GpgkeysDataTask::$testKeysPath . 'ada_public.key');
        $this->_gpg->import(GpgkeysDataTask::$testKeysPath . 'ada_private.key');
