...
- PB-25019 As an admin I can define LDAP filters case sensitivity
...
- PB-25859 As an admin notified of an account recovery I should see the first and last name of the acting user in the email
