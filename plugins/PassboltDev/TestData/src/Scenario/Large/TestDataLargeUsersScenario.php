...
use Passbolt\TestData\Command\Large\ProfilesDataCommand;
use Passbolt\TestData\Command\Large\UsersDataCommand;

class TestDataLargeUsersScenario implements FixtureScenarioInterface
{
    /**
     * @param mixed ...$args
     * @return array
