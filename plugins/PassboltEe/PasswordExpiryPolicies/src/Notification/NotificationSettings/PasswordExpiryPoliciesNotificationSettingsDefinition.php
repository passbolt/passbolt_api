...
namespace Passbolt\PasswordExpiryPolicies\Notification\NotificationSettings;
...
class PasswordExpiryPoliciesNotificationSettingsDefinition implements EmailNotificationSettingsDefinitionInterface
{
