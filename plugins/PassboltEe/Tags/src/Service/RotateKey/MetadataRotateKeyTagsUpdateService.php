 ...
 * @since         5.1.0
 */
namespace Passbolt\Tags\Service\RotateKey;
...
use Passbolt\Tags\Model\Validation\MetadataTagsBatchRotateKeyValidationService;

class MetadataRotateKeyTagsUpdateService extends AbstractMetadataRotateKeyUpdateService
{
    /**
    ...
    {
        $this->metadataBatchValidationService = new MetadataTagsBatchRotateKeyValidationService();
    }
