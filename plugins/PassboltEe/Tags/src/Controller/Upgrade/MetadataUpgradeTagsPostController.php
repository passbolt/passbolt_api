 ...
 * @since         5.1.0
 */
namespace Passbolt\Tags\Controller\Upgrade;
...
class MetadataUpgradeTagsPostController extends AppController
{
    /**
    ...
    public function post()
    {
        ...
        (new MetadataUpgradeTagsUpdateService())->updateMany(
        ...
        $tags = $this->Tags->findMetadataUpgradeIndex($options);
        $this->paginate($tags);
        $tags = $tags->all();
