...
class SsoProviderErrorCacheService extends AbstractSsoCacheService
{
    /**
    ...
    {
        return 'ssoLoginErrorAdminNotification';
    }
    ...
    public static function getConfigOptions(): array
    {
        return [
            'duration' => '+1 day',
            'path' => CACHE . 'sso' . DS . 'login_error_admin_notification' . DS,
        ];
    }
}
