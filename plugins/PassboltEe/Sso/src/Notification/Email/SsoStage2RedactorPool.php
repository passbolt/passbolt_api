...
use Passbolt\Sso\Notification\Email\Stage2\AzureSsoSecretExpiryNotifyRedactor;

class SsoStage2RedactorPool extends AbstractSubscribedEmailRedactorPool
{
    /**
    ...
    {
        return [
            new AzureSsoProviderErrorRedactor(),
            new AzureSsoSecretExpiryNotifyRedactor(),
        ];
    }
}
