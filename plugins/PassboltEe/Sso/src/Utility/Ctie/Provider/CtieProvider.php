...
namespace Passbolt\Sso\Utility\Ctie\Provider;
...
class CtieProvider extends BaseOauth2Provider
{
    ...
    public function __construct(array $options = [], array $collaborators = [])
    {
        ...
        $this->openIdBaseUri = $options['baseUrl'] ?? $this->openIdBaseUri;
    ...
    {
        return $this->openIdBaseUri . '/metadata/openid_Default_App_INT_ETAT/.well-known/openid-configuration';
    }
