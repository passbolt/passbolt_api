...
class SsoPingOneStage1Controller extends AbstractSsoController
{
    /**
     * @inheritDoc
     */
    ...
    public function stage1(AbstractSecureCookieService $cookieService): void
    {
        ...
        $url = $this->getSsoUrlWithCookie(new SsoPingOneService($cookieService), $uac, SsoState::TYPE_SSO_GET_KEY);
