...
class SsoPingOneStage2Controller extends AbstractSso2Stage2Controller
{
    /**
     * @inheritDoc
     */
    protected function ssoServiceFactory(
        ...
        return new SsoPingOneService($cookieService, $settingsDto);
    }
    ...
    {
        return SsoSetting::PROVIDER_PINGONE;
    }
}
