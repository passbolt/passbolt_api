...
{
    /**
     * @var \Passbolt\Sso\Model\Table\SsoKeysTable
     */
    protected $SsoKeys;
    ...
    {
        parent::setUp();
        $this->SsoKeys = TableRegistry::getTableLocator()->get('Passbolt/Sso.SsoKeys');
    }
     ...
     * @return void
     */
    public function testSsoKeysTable_NewEntitySuccess(): void
    {
