...
class Schema
{
    ...
    public const USER = [
        ...
        'meta' => [
            'resourceType' => 'Schema',
            'location' => '{scimUrl}/Schemas/urn:ietf:params:scim:schemas:core:2.0:User',
        ],
    ];
    ...
    public const GROUP = [
        ...
        'meta' => [
            'resourceType' => 'Schema',
            'location' => '{scimUrl}/Schemas/urn:ietf:params:scim:schemas:core:2.0:Group',
        ],
    ];
