...
class ScimUsersTableIntegrationTest extends AppTestCase
{
    public function testScimUsersTableIntegration_SoftDelete_ScimEntries_Plugin_Loaded(): void
    {
    ...
    public function testScimUsersTableIntegration_SoftDelete_ScimEntries_Plugin_Not_Loaded(): void
    {
        /** @var \Passbolt\Scim\Model\Entity\ScimEntry[] $scimEntries */
        $scimEntries = ScimEntryFactory::make(2)->withUser()->persist();
        $userToDelete = $scimEntries[0]->user;
