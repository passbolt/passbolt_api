...
namespace Passbolt\UserPassphrasePolicies\Service\Setup;
...
class RecoverStartUserPassphrasePoliciesInfoService implements RecoverStartInfoServiceInterface
{
    /**
     * @inheritDoc
     */
    public function getInfo(string $userId, string $token, ?array $data): array
    {
        ...
        $data['user_passphrase_policy'] = $userPassphrasePoliciesDto->toFilteredArray();
