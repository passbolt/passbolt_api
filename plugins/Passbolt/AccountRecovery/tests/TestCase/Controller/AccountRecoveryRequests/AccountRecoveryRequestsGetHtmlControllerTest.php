...
class AccountRecoveryRequestsGetHtmlControllerTest extends AccountRecoveryIntegrationTestCase
{
    use EmailQueueTrait;
    ...
    public function testAccountRecoveryRequestsGetController_Success()
    {
        ...
        $this->get(
            "/account-recovery/requests/$request->id/$request->user_id/$request->authentication_token_id"
        );
    ...
    public function testAccountRecoveryRequestsGetController_Bad_Request_ID()
    {
        ...
        $this->get("/account-recovery/requests/$requestId/$user->id/$token->id");
