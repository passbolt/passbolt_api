...
//    $routes->connect('/organization-policies.json', [
...
//    $routes->connect('/requests/:id.json', [
//            'prefix' => '', 'controller' => '', 'action' => ''])
//        ->setPass(['id'])
//        ->setMethods(['GET']);
//
...
//    $routes->connect('/requests/:userId/:tokenId.json', [
//            'prefix' => '', 'controller' => '', 'action' => ''])
//        ->setPass(['id', 'tokenId'])
//        ->setMethods(['GET']);
//
//    // POST /account-recovery/responses.json
//    $routes->connect('/responses.json', [
//            'prefix' => '', 'controller' => '', 'action' => ''])
//        ->setMethods(['POST']);
});
