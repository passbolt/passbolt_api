...
trait ActionLogsOperationsTrait
{
    ...
    {
        $ActionLogs = TableRegistry::get('Passbolt/Log.ActionLogs');
        $EntitiesHistory = TableRegistry::get('Passbolt/Log.EntitiesHistory');
        $PermissionsHistory = TableRegistry::get('Passbolt/Log.PermissionsHistory');
    ...
    public function simulateResourceSecretUpdate(UserAccessControl $user, string $resourceId)
    {
        $ActionLogs = TableRegistry::get('Passbolt/Log.ActionLogs');
        $EntitiesHistory = TableRegistry::get('Passbolt/Log.EntitiesHistory');
        $SecretsHistory = TableRegistry::get('Passbolt/Log.SecretsHistory');
