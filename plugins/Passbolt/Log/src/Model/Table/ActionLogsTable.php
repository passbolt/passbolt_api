...
class ActionLogsTable extends Table
{
     ...
     *
     * @param string $userAction log type in clear
     * @param array $status user_log data
     *
    ...
    public function create(UserAction $userAction, int $status)
    {
        ...
        if (!empty($log->getErrors())) {
            throw new ValidationException(__('Could not validate action_log data.', true), $log, $this);
        }
