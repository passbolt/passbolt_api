...
class ActionLogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'context' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            ...
            'user_id' => ['type' => 'index', 'columns' => ['user_id', 'action_id', 'status'], 'length' => []],
        ],
        '_constraints' => [
