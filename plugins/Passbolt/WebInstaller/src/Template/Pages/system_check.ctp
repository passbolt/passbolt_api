        ...
        <div class="grid grid-responsive-12">
            <div class="row">
                <div class="col7">
                    ...
                    <?php $healtcheck->assertEnvironment($data); ?>
                    ...
                    <h3><?php echo __('GPG Configuration'); ?></h3>
                    <?php $healtcheck->assertGpgEnv($data); ?>
                    ...
                    if (isset($data['ssl']) && $data['ssl']['is'] === true):
                        ...
                        echo '<div class="message warning">' . __('SSL access is not enabled. It is strongly recommended that you configure your web server to use HTTPS before you continue.') . '</div>';
                    endif;
                    ?>
                </div>
                <div class="col5 last">
