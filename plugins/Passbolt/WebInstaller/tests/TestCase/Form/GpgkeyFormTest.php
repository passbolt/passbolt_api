...
class GpgKeyFormTest extends AppTestCase
{
    ...
    public function testGpgKeyFormTestFieldPrivateKeyArmored()
    {
        ...
        $testCases = [
            'requirePresence' => self::getRequirePresenceTestCases(),
            'notEmpty' => self::getNotEmptyTestCases(),
            'isPrivateKey' => self::getServerKeyPrivateArmoredTestCases(),
            'hasNoExpiry' => self::getServerKeyPrivateArmoredHasNoExpiryTestCases(),
            'canDecrypt' => self::getServerKeyPrivateArmoredCanDecryptTestCases(),
        ];
        ...
        $testCases = [
            ...
            'match_public_private_fingerprint' => [
                ...
                'test_cases' => [
                    ...
                    self::getDummyData()['fingerprint'] => true,
                ]
            ]
        ];
        $this->assertFormFieldFormatValidation(GpgKeyForm::class, 'fingerprint', self::getDummyData(), $testCases);
    }

    /**
     * Get dummy test test data.
     *
...
WXi2h/I=
=L/Vu' => false,
                self::getDummyData()['private_key_armored'] => false,
                self::getDummyData()['public_key_armored'] => true,
            ],
        ];
    }
     ...
     * @return array
     */
    protected static function getServerKeyPrivateArmoredTestCases()
    {
        return [
...
=D76x' => false,
                self::getDummyData()['public_key_armored'] => false,
                self::getDummyData()['private_key_armored'] => true,
            ],
        ];
    }
...
-----END PGP PUBLIC KEY BLOCK-----' => false,
     ...
     * @return array
     */
    protected static function getServerKeyPrivateArmoredHasNoExpiryTestCases()
    {
        return [
            'rule_name' => 'has_no_expiry',
            'test_cases' => [
...
-----END PGP PRIVATE KEY BLOCK-----' => false,
     ...
     * @return array
     */
    protected static function getServerKeyPrivateArmoredCanDecryptTestCases()
    {
        return [
