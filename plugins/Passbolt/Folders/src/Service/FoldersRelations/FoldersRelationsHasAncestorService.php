...
class FoldersRelationsHasAncestorService
{
     ...
     *
     * @param string|null $folderId The target folder. Null if root
     * @param string $ancestorFolderId The potential folder ancestor
     * @param string $userId The user tree to check in
     * @param bool $stopBrowsingOnPersonal Stop browsing ancestors while meeting a personal folder
     * @return bool
     */
    public function hasAncestor(string $folderId = null, string $ancestorFolderId, string $userId, bool $stopBrowsingOnPersonal = false)
    {
        ...
        return $this->hasAncestor($folderParentId, $ancestorFolderId, $userId, $stopBrowsingOnPersonal);
    }
