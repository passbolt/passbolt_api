...
class FoldersRelationsAddItemToUserTreeService
{
    ...
    private function reconstructParent(UserAccessControl $uac, string $foreignModel, string $foreignId, string $userId, array $change)
    {
        ...
        // item.
        $usersIdsHavingAccessToFolderParent = $this->foldersRelationsTable->getUsersIdsHavingAccessToMultipleItems([$foreignId, $change['foreignId']]);
    ...
    private function reconstructChild(UserAccessControl $uac, string $foreignId, string $userId, array $change)
    {
        ...
        // added item.
        $usersIdsHavingAccessToItemAndProposedChild = $this->foldersRelationsTable->getUsersIdsHavingAccessToMultipleItems([$foreignId, $change['foreignId']]);
