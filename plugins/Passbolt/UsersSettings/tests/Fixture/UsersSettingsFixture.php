<?php
namespace Passbolt\UsersSettings\Test\Fixture;

use App\Utility\UuidFactory;
use Cake\TestSuite\Fixture\TestFixture;

/**
 * UsersSettingsFixture
 *
 */
class UsersSettingsFixture extends TestFixture
{
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => UuidFactory::uuid('user.settings.theme'),
