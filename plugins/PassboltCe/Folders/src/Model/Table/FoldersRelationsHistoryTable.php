 ...
 * @method \Passbolt\Folders\Model\Entity\FoldersRelation findOrCreate(\Cake\ORM\Query\SelectQuery|callable|array $search, callable|array|null $callback = null, array $options = [])
