...
class MfaRateLimiterServiceTest extends AppTestCase
{
    ...
    public function testMfaRateLimiterService_WithDefaultConfigValue_FailedAttemptsExceeded()
    {
    ...
    public function testMfaRateLimiterService_WithDefaultConfigValue_FailedAttemptsNotExceeded()
    {
        $user = UserFactory::make()->user()->persist();
        // login action
        ActionLogFactory::make(['created' => FrozenTime::now()->subMinute(2)])
    ...
    public function testMfaRateLimiterService_WithDefaultConfigValue_OldEntriesDoesnotCountAsFailedAttempts()
    {
        $user = UserFactory::make()->user()->persist();
        // Old actions
        ActionLogFactory::make(['created' => FrozenTime::now()->subMinute(2)])
