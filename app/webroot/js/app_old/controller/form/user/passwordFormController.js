steal(
	...
	'app/view/template/form/user/passwordForm.ejs'
		...
		/**
		 * @class passbolt.controller.form.user.PasswordFormController
		 ...
		 * @return {passbolt.controller.form.user.PasswordFormController}
		 */
		mad.form.FormController.extend('passbolt.controller.form.user.PasswordFormController', /** @static */ {
			'defaults': {
				'templateBased': true,
				'passwordField': null
			}
