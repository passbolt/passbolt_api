...
.then( 
    function($){
        ...
        /*
        * @class lb.core.model.lb.core.model.ModuleControllerActionDispatcher
        ...
        * @parent index
        */
        lb.core.model.DispatcherInterface.extend('lb.core.model.ModuleControllerActionDispatcher', {
            ...
            'dispatch' : function(route, options)
            {
                ...
                var pluginNameController = lb.core.helper.routeHelper.pluginNameController(route, {'prefix':'passbolt_'});
