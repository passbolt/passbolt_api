					...
					'events': {
						'click':function(elt, value){
							var myPopupComponent = mad.controller.component.PopupController.get({
								...
								.render()
								.addComponent(mad.controller.ComponentController, {
									'id':			'js_options_3',
									'templateUri':	'//app/plugin/sample/view/template/component/option.ejs'
								}, 'js_popup_content')
								.setViewData('value', 'popup options value')
								.render();
						}
					}
				});
					...
					'events': {
						'click':function(elt, value){
							var myCreateModelPopupComponent = mad.controller.component.PopupController.get({
								...
								.render()
								.addComponent(passbolt.sample.controller.component.CreateBrolFormController, {
...
//                notifContainer.render();
			...
			'ready': function()
			{
				...
				var database = new passbolt.model.Database({id: '501cfdec-b4dc-4aa3-91b3-0ea56511fe85'});
