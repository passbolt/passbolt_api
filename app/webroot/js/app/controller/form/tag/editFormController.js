steal(
  ...
  mad.form.FormController.extend('passbolt.controller.form.tag.EditFormController', /** @static */ {
    ...
    'afterStart' : function() {
      ...
      this.addElement(new mad.form.element.TextboxController($('.tag_foreign_model', this.element), {
        modelReference : 'passbolt.model.ItemTag.foreign_model'
      }).start().setValue(this.options.foreignModel));

      // foreign_id hidden field
      this.addElement(new mad.form.element.TextboxController($('.tag_foreign_id', this.element), {
      ...
      this.tagList = this.addElement(new mad.form.element.TextboxController($('.tag_list', this.element), {
