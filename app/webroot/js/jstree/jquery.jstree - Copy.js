		...
		_fn : { 
			...
			open_node	: function (obj, callback, skip_animation) {
				...
				if(!this._is_loaded(obj)) {
					...
					//alert(concatObject(obj));
					//this.__callback({ "obj" : obj });   // this was generating a bug. (deselection of the node while opening children) Let's be careful that it doesn't create other bugs coz it's commented
															// 10/02 : conclusion, it's creating another bug with the cookie plugin. To be uncommented and find another solution for the above problem
