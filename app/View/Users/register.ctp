		...
		<div class="col4 push1 last">
			...
			<div class="users register form">
				...
				<fieldset>
					...
					<?php echo $this->Form->input('Profile.first_name', array('label' => __('First name'), 'class' =>'required fluid')); ?>
					<?php echo $this->Form->input('Profile.last_name', array('label' => __('Last name'), 'class' =>'required fluid')); ?>
					<?php echo $this->Form->input('User.username', array('label' => __('Email'), 'class' =>'required fluid')); ?>
				</fieldset>
