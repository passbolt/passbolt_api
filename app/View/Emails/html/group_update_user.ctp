                                ...
                                <table align="Right" border="0" cellpadding="0" cellspacing="0" width="360" class="flexibleContainer" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                    <tr>
                                        <td valign="top" class="textContent" style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #404040;font-family: Helvetica;font-size: 14px;line-height: 125%;text-align: Left;padding-bottom: 20px;">
                                            ...
                                            <span style="">updated your group membership</span><br>
                                            <span style="color:#888888">on <?php echo date('M d, Y \a\t H:i', $updateTime); ?></span><br>
                                        </td>
                                    </tr>
                                </table>
                                <!-- // CONTENT TABLE -->
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td valign="top" class="textContent">
                                        Group name: <?php echo $group['Group']['name'] ?><br>
                                        New role: <?php echo $groupUser['GroupUser']['is_admin'] ? __('Group manager') : __('Member') ?>
                                    </td>
                                </tr>
                            </table>
                            <!-- // CONTENT TABLE -->
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td valign="top" class="textContent" align="center">
                                        ...
                                        As group manager you are now authorized to edit the members of this group.
                                        As member of the group you still have access to all the passwords that are shared with this group.
                                        <?php } else { ?>
                                        You are no longer a group manager of this group.
                                        You are no longer authorized to edit the members of this group.
                                        As member of the group you still have access to all the passwords that are shared with this group.
                                        <?php } ?>
                                    </td>
                                </tr>
