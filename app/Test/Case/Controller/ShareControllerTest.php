...
//	public function testUpdatePermissionsForResource() {
//		// log with a user who has right on the unit test sandbox category
//		$kk = $this->User->findByUsername('darth.vader@passbolt.com');
//		$jr = $this->User->findByUsername('jean-rene@test.com');
//		$this->User->setActive($kk);
//
//		// Add a permission for a given user to a given category
//		$model = 'resource';
//		$resName = 'tetris license';
//		$resource = $this->Resource->findByName($resName);
//
//		$id = $resource['Resource']['id'];
//		$srvResult = json_decode(
//			$this->testAction("/permissions/resource/$id.json",
//				array(
//					'method' => 'get',
//					'return' => 'contents'
//				)
...
//
//		// check how many permissions are already existing before the new insertion
//		$res = $this->testAction("/share/$model/$id.json", array(
//				'method' => 'put',
//				'return' => 'contents',
//				'data' => $data
//			), true);
//		print_r($res);
//		$srvResult = json_decode($res);
//	}
}